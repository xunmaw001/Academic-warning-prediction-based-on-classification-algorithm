...
public class BlogControllerAdmin {
  ...
  @ResponseBody
  public Map<String, Object> uploadBlogImage(String prarm, HttpServletRequest request)
      throws Exception {
    CommonsMultipartResolver multipartResolver =
        new CommonsMultipartResolver(request.getSession().getServletContext());
    Map<String, Object> map = new HashMap<String, Object>();
  ...
  public Map<String, Object> selectGroupLikeBlogListByPage(
      Blog blog,
  ...
  @ResponseBody
  @AccessLimit(seconds = 1, maxCount = 13)
  public Map<String, Object> selectBlogListByPage(
      Blog blog,
      @RequestParam(value = "page", required = true, defaultValue = "1") Integer page,
      @RequestParam(value = "pageSize", required = true, defaultValue = "10") Integer pageSize)
      throws Exception {
