...
public class BlogTypeControllerAdmin {
  ...
  @ResponseBody
  public List<BlogType> selectBlogType(@RequestParam(value = "data", required = false) String data)
      throws Exception {
  ...
  public Map<String, Object> deleteBlogType(String prarm, HttpSession session, BlogType blogType)
      throws Exception {
    Map<String, Object> map = new HashMap<String, Object>();
  ...
  public Map<String, Object> updateBlogType( String prarm, HttpSession session,BlogType blogType)
      throws Exception {
    Map<String, Object> map = new HashMap<String, Object>();
    String username = (String) session.getAttribute("username");
    Bloger bloger = blogerService.findUserByLoginName(username);
