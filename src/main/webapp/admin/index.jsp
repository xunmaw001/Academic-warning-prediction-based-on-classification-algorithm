			...
			<div class="sidebar-collapse">
				<ul class="nav" id="side-menu">
                    ...
                    <li><a href="#"><i class="fa fa-book"></i> <span
							class="nav-label">成绩分析</span><span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
								<li><a class="J_menuItem"
								href="${pageContext.request.contextPath}/admin/scores/scoresTable.jsp">成绩管理</a>
							</li>
							
							<li><a class="J_menuItem"
								href="${pageContext.request.contextPath}/admin/scores/eCharts.jsp">成绩分析</a>
							</li>
						</ul></li>
					
					<li><a class="J_menuItem" href="${pageContext.request.contextPath}/admin/charts/eCharts.jsp"><i class="fa fa-bar-chart"></i><span
							class="nav-label">统计分析预测</span></a>
						</li>
						
					<li><a href="#"><i class="fa fa-book"></i> <span
							class="nav-label">课程模块</span><span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
								<li><a class="J_menuItem"
								href="${pageContext.request.contextPath}/admin/blog/blogTable.jsp">课程管理</a>
							</li>
								
							<li><a class="J_menuItem"
								href="${pageContext.request.contextPath}/admin/blog/addBlog.jsp">写课程</a>
							</li>
							
							<li><a class="J_menuItem"
								href="${pageContext.request.contextPath}/admin/blog/findBlog.jsp">查询课程</a>
							</li>
							<li><a class="J_menuItem"
								href="${pageContext.request.contextPath}/admin/blog/blogType.jsp">课程类别</a>
							</li>
		...
		<div id="page-wrapper" class="white-bg dashbard-1">
			...
			<div class="footer">
				<div class="pull-right">
					&copy; 2019 <a href="#" target="_blank">学业警示预测
						学业警示预测</a>
				</div>
			</div>
		</div>
