						...
						<div class="file-manager">
							...
							<ul class="folder-list m-b-md" style="padding: 0">
                                ...
                                <li><a href="javascript:void(0)" onclick="fastToSearch('普通用户')"><i class="fa fa-user-plus"></i>普通用户</a>
                                 ...
                                 <li><a href="javascript:void(0)" onclick="fastToSearch('查看成绩')"><i class="fa fa-tag"></i> 查看成绩</a>
                                </li>
                                 <li><a href="javascript:void(0)" onclick="fastToSearch('关键字查询成绩')"><i class="fa fa-tag"></i> 关键字搜索成绩</a>
                                </li>
							...
							<ul class="folder-list m-b-md" style="padding: 0">
							 <li><a href="javascript:void(0)" onclick="fastToSearch('管理员')"><i class="fa fa-user"></i> 管理员</a>
                                ...
                                <li><a href="javascript:void(0)" onclick="fastToSearch('更新成绩')"><i class="fa fa-tag"></i> 成绩(增/删/改)</a>
                                </li>
                                <li><a href="javascript:void(0)" onclick="fastToSearch('修改成绩类别')"><i class="fa fa-tag"></i> 成绩类别(增/删/改)</a>
                                </li>
