...
<head>
<meta charset="utf-8">
<title>列表页_个人成绩 - 一个在Java道路上的技术员个人成绩网站</title>
<link rel="shortcut icon"
  href="${pageContext.request.contextPath}/images/favicon.ico">
<meta name="keywords" content="个人成绩,罗廷方个人成绩,罗廷方" />
<meta name="description" content="罗廷方个人成绩，是一个在Java道路上的技术员个人成绩网站" />
  ...
  <article>
    <div class="lbox">
      <div class="whitebg lanmu">
        ...
        <h1>个人成绩日记</h1>
        <p>个人成绩日记，记录了我成绩建站初到现在的过程，还有我从毕业到现在的一个状态，感谢您的阅读，如果你还是学生，也许你能从此文中，找到我们曾经相似的地方。如果你已经工作，有自己的成绩，我想，你并没有忘记当初建立个人成绩的初衷吧！</p>
      </div>
