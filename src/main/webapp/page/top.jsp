...
<header id="header">
  <div class="navbox">
    ...
    <div class="logo">
      <a href="/">哈尔滨华德学院 | <font class="font16">基于分类算法的学业警示预测</font></a>
    </div>
    <nav>
      <ul id="starlist">
        <li><a href="${pageContext.request.contextPath}/index" title="首页" >网站首页</a></li>
        <li><a href="${pageContext.request.contextPath}/about">关于哈尔滨华德学院</a></li>
  ...
  var initAllBlogType = function() {
    ...
    jQuery(document).ready(function($) {
      ...
      $("body").click(function(e) {
        ...
        var a = new Array("Hello", "你再点", "你继续点", "你有本事接着点");
